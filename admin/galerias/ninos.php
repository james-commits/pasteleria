...
if (isset($_FILES['image']) && isset($_POST['name'])) {
  ...
  if ($image['error'] === UPLOAD_ERR_OK) {
    ...
    $data = [];
    if (file_exists('../../js/ninos.json')) {
      $json = file_get_contents('../../js/ninos.json');
    ...
    file_put_contents('../../js/ninos.json', json_encode($data));
    
 
    header("Location: ninos.html");
    echo "Exito";
  } else {
