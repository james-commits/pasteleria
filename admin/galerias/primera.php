...
if (isset($_FILES['image']) && isset($_POST['name'])) {
  ...
  if ($image['error'] === UPLOAD_ERR_OK) {
    ...
    $data = [];
    if (file_exists('../../js/primeraCom.json')) {
      $json = file_get_contents('../../js/primeraCom.json');
    ...
    $ruta = 'img/primeraComunion'.$sig.$str;
    ...
    file_put_contents('../../js/primeraCom.json', json_encode($data));
